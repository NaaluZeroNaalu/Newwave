...
def generate_consolidated_ncr_OpenClose_excel(combined_result, report_title="NCR"):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        category_map = {
            'Civil Finishing': ['FW', 'Civil Finishing', 'Finishing'],
        ...
        for site in sorted_sites:
            ...
            if "Tower" in site and site != "Common_Area":
                resolved_module_counts = {level: {'Civil Finishing': 0, 'Structure Works': 0, 'MEP': 0} for level in tower_levels}
                open_module_counts = {level: {'Civil Finishing': 0, 'Structure Works': 0, 'MEP': 0} for level in tower_levels}
                resolved_common_counts = {'Civil Finishing': 0, 'Structure Works': 0, 'MEP': 0}
                open_common_counts = {'CivilFinishing': 0, 'Structure Works': 0, 'MEP': 0}
